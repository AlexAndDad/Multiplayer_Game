...
Shaders::Shaders(std::string const &vertexPath, std::string const &geometryPath, std::string const &fragmentPath)
{
    ...
    if (!success)
    {
        ...
        glGetShaderInfoLog(geometry,length,nullptr,result.data());
